        ...
        <g id="top">
            ...
            <g id="topText" font-family="'20th Century Font', 'Futura XBlk BT'" font-size="75" text-anchor="middle" 
               fill="white" filter="url(#dropShadow)">
                <text y=".3em"><tspan font-size="95">batik</tspan> <xsl:value-of select="$version" /></text>
                <text y="3em" font-size="17">http://xml.apache.org/batik</text>
            </g>

            <xsl:if test="$revisionType != 'revisionType'">
            <g id="betaStamp" transform="translate(170, 20) rotate(-30) scale(.7)" filter="url(#dropShadow)">
