...
/**
 * Factory class for vending <tt>GraphicsNodeEventFilter</tt> objects.
 *
...
public interface GraphicsNodeEventFilterBridge extends Bridge {
    ...
    /**
     * Creates a <tt>GraphicsNodeEventFilter</tt> using the specified
     * context and element.
     * @param ctx the context to use
     * @param element the Element with the 'pointer-events' attribute
     */
    GraphicsNodeEventFilter createGraphicsNodeEventFilter(
