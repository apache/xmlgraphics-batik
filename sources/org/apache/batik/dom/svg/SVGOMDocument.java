               ...
               SVGConstants
{
    ...
    {
        factories.put("a",                new AElementFactory());
        factories.put("circle",           new CircleElementFactory());
        factories.put("defs",             new DefsElementFactory());
        factories.put("desc",             new DescElementFactory());
        factories.put("ellipse",          new EllipseElementFactory());
        ...
        factories.put("line",             new LineElementFactory());
        factories.put("path",             new PathElementFactory());
        factories.put("polygon",          new PolygonElementFactory());
        factories.put("polyline",         new PolylineElementFactory());
        factories.put("rect",             new RectElementFactory());
        factories.put("style",            new StyleElementFactory());
        factories.put("svg",              new SvgElementFactory());
        factories.put("switch",           new SwitchElementFactory());
        factories.put("symbol",           new SymbolElementFactory());
        factories.put("text",             new TextElementFactory());
        factories.put("title",            new TitleElementFactory());
        factories.put("use",              new UseElementFactory());
    }
    ...
    protected class FEGaussianBlurElementFactory implements ElementFactory {
         ...
         */
        public Element create(String prefix) {
            return new SVGOMFEGaussianBlurElement(prefix, SVGOMDocument.this);
        }
    }
