...
public class DefaultBumpMap implements BumpMap {
         ...
         int w, int h)
    {
        ...
        n[0] = - surfaceScaleX *((2*crnc + nrnc - 2*crcc - nrcc));
        n[1] = - surfaceScaleY *((2*nrcc + nrnc - 2*crcc - crnc));
        norm = Math.sqrt(n[0]*n[0] + n[1]*n[1] + 1);
        n[0] /= norm;
        n[1] /= norm;
        n[2] = 1/norm;
        ...
        for(j=1; j<w-1; j++){
            ...
            n = N[0][j];
            n[0] = - surfaceScaleX * 1/2 * (( 2*crnc + nrnc)
                                     - (2*crpc + nrpc));
        ...
        crcc = crnc;
        nrcc = nrnc;
        n[0] = - surfaceScaleX *(( 2*crcc + nrcc)
                                      - (2*crpc + nrpc));
        n[1] = - surfaceScaleY *(( 2*nrcc + nrpc)
                                      - (2*crcc + crpc));
        ...
        for(i=1; i<h-1; i++){
            ...
            n[0] = - surfaceScaleX * 1/2 *(( prnc + 2*crnc + nrnc)
                                          - (prcc + 2*crcc + nrcc));
            n[1] = - surfaceScaleY * 1/2 *(( 2*prcc + prnc)
                                          - ( 2*crcc + crnc));
        ...
        for(i=1; i<h-1; i++){
            ...
            n[0] = - surfaceScaleX * 1/2*(( prcc + 2*crcc + nrcc)
                                          - (prpc + 2*crpc + nrpc));
            n[1] = - surfaceScaleY * 1/2*(( nrpc + 2*nrcc)
                                          - ( prpc + 2*prcc));
        ...
        n[0] = - surfaceScaleX * ((2*crnc + prnc - 2*crcc - prcc));
        n[1] = - surfaceScaleY * ((2*crcc + crnc - 2*prcc - prnc));
        norm = Math.sqrt(n[0]*n[0] + n[1]*n[1] + 1);
        n[0] /= norm;
        n[1] /= norm;
        n[2] = 1/norm;
        ...
        for(j=1; j<w-1; j++){
            ...
            n = N[h-1][j];
            n[0] = - surfaceScaleX * 1/2*(( 2*crnc + prnc)
                                          - (2*crpc + prpc));
        ...
        n = N[h-1][w-1];
        n[0] = - surfaceScaleX *(( 2*crcc + prcc)
                               - (2*crpc + prpc));
        n[1] = - surfaceScaleY *(( 2*crcc + crpc)
                               - (2*prcc + prpc));
