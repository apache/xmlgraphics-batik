 ...
 * @version $Id$
 */
public class OpacityResolver implements RelativeValueResolver {
    /**
     * The accumulate CSS value.
     */
    public final static CSSOMReadOnlyValue N_1 =
        new CSSOMReadOnlyValue(OpacityFactory.ONE);
     ...
     */
    protected boolean inheritedProperty;

    /**
     * Creates a new OpacityResolver object.
     * @param name The handled property name.
     * @param b The inheritedProperty value.
     */
    public OpacityResolver(String name, boolean b) {
        propertyName = name;
        inheritedProperty = b;
    }
