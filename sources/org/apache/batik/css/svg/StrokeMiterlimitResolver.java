 ...
 * @version $Id$
 */
public class StrokeMiterlimitResolver implements RelativeValueResolver {
    /**
     * The 4 CSS value.
     */
    public final static CSSOMReadOnlyValue N_4 =
        new CSSOMReadOnlyValue(StrokeMiterlimitFactory.FOUR_VALUE);
