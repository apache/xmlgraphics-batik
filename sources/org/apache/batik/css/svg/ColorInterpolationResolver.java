 ...
 * @version $Id$
 */
public class ColorInterpolationResolver implements RelativeValueResolver {
	...
	return SVGValueConstants.CSS_COLOR_INTERPOLATION_PROPERTY;
    }
	...
	return new CSSOMReadOnlyValue(SVGValueConstants.SRGB_VALUE);
    }
