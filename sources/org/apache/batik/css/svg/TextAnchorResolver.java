 ...
 * @version $Id$
 */
public class TextAnchorResolver implements RelativeValueResolver {
	...
	return SVGValueConstants.CSS_TEXT_ANCHOR_PROPERTY;
    }
	...
	return new CSSOMReadOnlyValue(SVGValueConstants.START_VALUE);
    }
