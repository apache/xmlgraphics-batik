 ...
 * @version $Id$
 */
public class BaselineShiftResolver implements RelativeValueResolver {
    /**
     * The baseline CSS value.
     */
    public final static CSSOMReadOnlyValue BASELINE =
        new CSSOMReadOnlyValue(BaselineShiftFactory.BASELINE_VALUE);
