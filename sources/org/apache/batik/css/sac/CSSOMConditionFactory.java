...
public class CSSOMConditionFactory implements ConditionFactory {
    ...
    public CombinatorCondition createAndCondition(Condition first,
                                                  Condition second)
	throws CSSException {
	return new CSSOMAndCondition(first, second);
    }
    ...
    public AttributeCondition createAttributeCondition(String localName,
						       ...
						       String value)
	throws CSSException {
	return new CSSOMAttributeCondition(localName, namespaceURI, specified,
                                           value);
    }
    ...
    public AttributeCondition createIdCondition(String value)
        throws CSSException {
	return new CSSOMIdCondition(value);
    }
	...
	return new CSSOMLangCondition(lang);
    }
 ...
 ConditionFactory#createOneOfAttributeCondition(String,String,boolean,String)}.
    ...
    public AttributeCondition createOneOfAttributeCondition(String localName,
							    ...
							    String value)
	throws CSSException {
	return new CSSOMOneOfAttributeCondition(localName, nsURI, specified,
                                                value);
    }
    ...
    public AttributeCondition createBeginHyphenAttributeCondition
        (String localName,
         ...
         String value)
	throws CSSException {
	return new CSSOMBeginHyphenAttributeCondition
    ...
    public AttributeCondition createClassCondition(String namespaceURI,
						   String value)
	throws CSSException {
	return new CSSOMClassCondition(namespaceURI, value);
    }
    ...
    public AttributeCondition createPseudoClassCondition(String namespaceURI,
							 String value)
	throws CSSException {
	return new CSSOMPseudoClassCondition(namespaceURI, value);
    }
