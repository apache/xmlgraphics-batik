...
public class CSSOMIdCondition extends AbstractAttributeCondition {
    /**
     * Creates a new CSSOMAttributeCondition object.
     */
    public CSSOMIdCondition(String value) {
	super(value);
    }
	...
	return (e instanceof ElementWithID)
	    ? ((ElementWithID)e).getID().equals(getValue())
	    : false;
    }
