 ...
 * @version $Id$
 */
public class CSSOMPseudoClassCondition extends AbstractAttributeCondition {
    /**
     * The namespaceURI.
     */
     ...
     */
    public CSSOMPseudoClassCondition(String namespaceURI, String value) {
	super(value);
	...
	CSSOMPseudoClassCondition c = (CSSOMPseudoClassCondition)obj;
	...
	return (e instanceof ElementWithPseudoClass)
	    ? ((ElementWithPseudoClass)e).matchPseudoClass(getValue())
	    : false;
    }
