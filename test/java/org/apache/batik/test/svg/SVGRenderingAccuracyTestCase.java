 ...
 */
@Ignore
public class SVGRenderingAccuracyTestCase extends AbstractRenderingAccuracyTest {
    /**
     ...
     */
    public SVGRenderingAccuracyTestCase(String svgURL,
                                    String refImgURL){
     ...
     * For subclasses
     */
    protected SVGRenderingAccuracyTestCase(){
    }
    ...
    protected class InternalPNGTranscoder extends PNGTranscoder{
        ...
        protected void transcode(Document document,
            ...
            SVGRenderingAccuracyTestCase.this.manipulateSVGDocument(document);
