 ...
 */
@Ignore
public class JSVGInterruptTestCase extends JSVGMemoryLeakTestCase {

    public String getName() { return "JSVGInterruptTestCase."+getId(); }

    public JSVGInterruptTestCase() {
    }
    ...
    public int doTweak(Runnable r, SetDelayable delayable) {
        synchronized (JSVGInterruptTestCase.this) {
            int delay = 0;
            int delayInc = 3;
            int delayIncInc = 4;
            int ret = 0;
            ...
            while ((state & (COMPLETE | FAILED)) == 0) {
                ...
                while ((state == 0) && (curr < end)) {
                    ...
                    try {
                        JSVGInterruptTestCase.this.wait(end-curr);
    ...
    class MyLoaderListener implements SVGDocumentLoaderListener, SetDelayable {
        ...
        public void documentLoadingCompleted(SVGDocumentLoaderEvent e) {
            ...
            synchronized (JSVGInterruptTestCase.this) {
                state |= COMPLETE;
                JSVGInterruptTestCase.this.notifyAll();
            }
        }
